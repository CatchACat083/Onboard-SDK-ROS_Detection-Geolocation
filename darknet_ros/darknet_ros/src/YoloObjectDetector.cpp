...
void YoloObjectDetector::init() {
  ...
  nodeHandle_.param("subscribers/camera_reading/topic", cameraTopicName, std::string("/dji_osdk_ros/main_camera_images"));
  ...
  //------------ DJI OSDK ROS Camera -------------//
  // setup_camera_stream_client = nodeHandle_.serviceClient<dji_osdk_ros::SetupCameraStream>("setup_osdk_camera_stream");
  ...
  //---------- DJI OSDK Camera subsccribe ------------- //
  //imageSubscriber_ = imageTransport_.subscribe("/dji_osdk_ros/main_camera_images", cameraQueueSize, &YoloObjectDetector::cameraCallback, this);
...
void* YoloObjectDetector::publishInThread() {
  ...
  if (num > 0 && num <= 100) {
    ...
    std_msgs::Header this_header = headerBuff_[(buffIndex_ + 1) % 3];
    msg.header.stamp = this_header.stamp;
    ...
    // ========= boundingBoxesResults.stamp == source image.stamp =========== //
